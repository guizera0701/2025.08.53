int main()
{
    // Declaração de um array de inteiros chamado 'pontuncoes_clientes com 5 elementos
    int pontuacoes_clientes[5];

    // Atribuindo valores aos elementas do array
    // O primeiro cliente (indice 0) tem 90 pontos
    ...
    int soma pontuacoes = 0;
    soma_pontuacoes pontuacoes_clientes[0] pontuacoes_clientes[1] +

        pontuacoes_clientes[2] pontuacoes_clientes[4];
